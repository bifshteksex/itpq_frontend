  ...
  >
    ...
    <div class="w-full">
      <section class="w-full flex flex-col items-center">
        <h2 class="text-2xl font-semibold mb-4">Мои подписки</h2>

        <div class="flex gap-5">
          <a
            href="/"
            class="p-4 border rounded dark:bg-gray-700 dark:text-white"
          >
            <div class="flex items-center gap-x-5">
              ...
              <div>
                ...
                <p>Новых вакансий: 2</p>
              </div>
            </div>
            <button class="rounded bg-red-500 w-full mt-3">Отписаться</button>
          </a>
